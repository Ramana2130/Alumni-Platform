      ...
      <div className="flex mx-auto bg-[#1E1E1E] p-16 rounded-2xl justify-center items-center">
        <div className="relative w-[35%]">
          <div className="h-[700px] w-[500px] p-5">
            <h1 className="text-white font-semibold text-4xl w-96 uppercase">
 
              Let's Donation Student <span className='text-[#CFF80B]'>Account!</span> 
            </h1>
            <div className='mt-24'>
          ...
          {step === 3 && (
            <div className="h-[700px] bg-[#111111] relative flex items-center rounded-[20px] xl:p-10 2xl:p-16 lg:p-10 md:p-10 sm:p-2">
              <div className="text-center">
                ...
                <p className=" mt-4 text-lg text-[#CFF80B]">Student account donated has been successfully.</p>
