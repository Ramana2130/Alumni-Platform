...
export async function addAlumni(data: any) {
  const res = await axios.post(
    `${import.meta.env.VITE_BACKEND_URL}/alumni-details/add`,
    data
  );
  return res.data;
}
...
export async function getAllAlumni() {
  const res = await axios.get(
    `${import.meta.env.VITE_BACKEND_URL}/alumni-details/getAll`
  );
  return res.data;
}
...
export async function getAlumniById(id: number) {
  const res = await axios.get(
    `${import.meta.env.VITE_BACKEND_URL}/alumni-details/getById/${id}`
  );
  return res.data;
}
...
export async function updateAlumni(id: number, data: any) {
  const res = await axios.put(
    `${import.meta.env.VITE_BACKEND_URL}/alumni-details/updateById/${id}`,
    data
  );
  return res.data;
}
...
export async function deleteAlumni(id: number) {
  const res = await axios.delete(
    `${import.meta.env.VITE_BACKEND_URL}/alumni-details/deleteById/${id}`
  );
  return res.data;
}
...
export async function getAlumniByEmail(email: string) {
  const res = await axios.get(
    ...
    }/alumni-details/getByEmail/${encodeURIComponent(email)}`
  );
  return res.data;
}
...
export async function getDashboardCounts() {
  const res = await axios.get(
    `${import.meta.env.VITE_BACKEND_URL}/current-alumni-details/counts`
  );
  return res.data;
}
