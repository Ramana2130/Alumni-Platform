...
export function StudentAlumniProfileSummary({
  ...
  return (
    <Card className="w-[1200px] mx-auto shadow-lg border-0 bg-red-50 text-black">
      <CardHeader className="pb-4 uppercase">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full flex items-center justify-center text-white text-xl font-bold bg-red-600">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 pl-7">
              ...
              <div className="flex items-center gap-2">
                <Goal className="w-4 h-4 opacity-60" />
                <span className="text-sm">{designation}</span>
              </div>
              <div className="flex items-center gap-2">
                <MapPin className="w-4 h-4 opacity-60" />
                <span className="text-sm">Lives in {jobLocation}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3 pt-4 border-t border-red-200">
          <Button className="flex-1 text-white font-medium bg-red-600 hover:bg-red-700">
            <MessageSquare className="w-4 h-4 mr-2" />
            Chat
          </Button>
          {/* <Button variant="outline" className="flex-1 bg-transparent border-red-600 text-red-700 hover:bg-red-50">
