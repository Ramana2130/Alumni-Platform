...
export function StudentAlumniProfileSummary({
  ...
  return (
    <Card className="w-[1210px] mx-auto shadow-lg border-0 bg-gray-50 text-red-900">
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full flex items-center justify-center text-white text-xl font-bold bg-[#e7000b]">
              <User className="w-8 h-8" />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-balance text-red-900">{name}</h2>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex gap-3 pt-4 border-t border-red-200">
          <Button className="flex-1 text-white font-medium bg-[#e7000b] hover:bg-red-700">
            <MessageSquare className="w-4 h-4 mr-2" />
            Chat
          </Button>
          <Button variant="outline" className="flex-1 bg-transparent border-[#e7000b] text-red-700 hover:bg-red-50">
