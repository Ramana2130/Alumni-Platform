...
import { Edit, Trash2, MoreHorizontal, Search, ChevronLeft, ChevronRight } from "lucide-react"
                  ...
                  <TableCell>
                    {request.status === "approved" ? (
                      <div className="flex items-center gap-2 min-w-[120px]">
                        <Progress value={request.progressPercentage} className="flex-1 h-2" />
