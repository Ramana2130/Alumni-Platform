    ...
    <Card className="w-full  mx-auto shadow-lg border-0 bg-gray-100 text-emerald-950">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex gap-3 pt-4 border-t border-emerald-200">
          <Button className="flex-1 text-white font-medium bg-emerald-600 hover:bg-emtext-emerald-800">
            <MessageSquare className="w-4 h-4 mr-2" />
            Chat
          </Button>
          <Button variant="outline" className="flex-1 bg-transparent border-emerald-600 text-emerald-800 hover:bg-emerald-50">
