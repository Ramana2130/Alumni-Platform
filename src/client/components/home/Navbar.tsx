...
const Navbar = () => {
  return (
    <header className="fixed inset-x-0 top-0 z-30 mx-auto w-full max-w-screen-md  bg-white/80 py-3  backdrop-blur-lg  lg:max-w-screen-xl">
      <div className="px-4">
