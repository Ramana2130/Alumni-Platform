      ...
      <Card className="w-[1200px] mx-auto bg-card  shadow-lg">
        <CardHeader className="bg-orange-50 border-b border-orange-200">
          ...
          <CardDescription className="text-muted-foreground">
            Fill out the details below to share your event with the alumni
            community
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Optional: Provide a link where alumni can register for your
                event
              </p>
            </div>
            ...
            <div className="flex items-center space-x-2 p-4 bg-orange-50 rounded-lg border border-orange-200">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleInputChange("sendNotification", checked as boolean)
                }
